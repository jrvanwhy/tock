...
pub struct VirtIOMMIODevice<R: virtio_mmio_device_registers::Interface> {
    regs: R,
...
impl<R: virtio_mmio_device_registers::Interface> VirtIOTransport for VirtIOMMIODevice<R> {
    fn initialize(
        &self,
        ...
        self.regs
            .device_status()
            .modify(DeviceStatus::DriverOk::SET);
